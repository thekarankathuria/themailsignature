export function CesAffiliateHero() {
  return (
    <div className="section_hero">
      <div className="container-large">
        <div className="hero-grid-relative">
          <div className="hero_grid">
            <div className="about-grid join">
              <div className="about-hero-text-wrapper">
                ...
                <div>
                  <h1 className="heading text-align-left">Join Mail</h1>
                  <div className="heading_block text-align-left">
                    <h2 className="heading-style-h1">Signature</h2>
                    <img
                  ...
                  <div className="heading_block text-align-left">
                    <h2 className="heading-style-h1 highlight_text">
                      Affiliate Program
                    </h2>
                  </div>
                </div>
                ...
                <p className="text-size-medium text-align-left">
                  Join as an affiliate and earn lucrative rewards by sharing the
                  world&#x27;s leading email signature platform with your community.
                  Turn your referrals into steady income!
                </p>
                <div className="spacer-custom1 _40px"></div>
                <div className="button-wrapper">
                  <a
                    href="https://custom-esignature-1.getrewardful.com/signup"
                    target="_blank"
                  ...
                  <a
                    href="https://www.loom.com/share/dd2870154f66449c8c87364ed4780a52?sid=a593531a-a310-4474-b8ca-a8441220d14a"
                    target="_blank"
              ...
              <div className="video-wrapper-about">
                <img
                  src="/ces/img/6890b8fbceccc588de4088e2_Frame-1707479515.avif"
                  loading="lazy"
                  sizes="(max-width: 1257px) 100vw, 1257px"
                  alt=""
                  srcSet="/ces/img/6890b8fbceccc588de4088e2_Frame-1707479515-p-500.avif 500w, /ces/img/6890b8fbceccc588de4088e2_Frame-1707479515-p-800.png 800w, /ces/img/6890b8fbceccc588de4088e2_Frame-1707479515-p-1080.avif 1080w, /ces/img/6890b8fbceccc588de4088e2_Frame-1707479515.avif 1257w"
                />
              </div>
            </div>
          </div>
