/**
 * `.section_hero` from contact-us.html — ported 1:1 from the Webflow original.
 *
 ...
 * DOM because `app/ces-extra.css` already hides the decorative hero wash by selector, the
 * same way `components/ces/CesHero.tsx` handles it.
 */
export function CesContactHero() {
  return (
                ...
                <div className="section-sub-tag-title different-7">
                  <div className="bullet-list-icon different-8">
                    <div className="html-code different-9 w-embed">
                      ...
                      >
                        <g clipPath="url(#clip0_2003_12337_ch)">
                          <path
                            ...
                            fill="url(#paint0_linear_2003_12337_ch)"
                          ></path>
                        </g>
                        <defs>
                          <linearGradient
                            id="paint0_linear_2003_12337_ch"
                            x1="2.5"
                            y1="7.99843"
                            x2="13.4987"
                            y2="7.99843"
                          ...
                          <clipPath id="clip0_2003_12337_ch">
            ...
            <div className="hero_content">
              <div>
                <div className="heading_block">
                  <h1 className="heading">How Can We</h1>
                  <img
                ...
                <div className="heading_block">
                  <h2 className="heading-style-h1">
                    <span className="highlight_text">Help You Today?</span>
                  </h2>
                </div>
              </div>
              <div className="paragraph_wrapper">
                <p className="text-size-medium">
                  ...
                  we&#8217;re always ready to listen and respond.
                </p>
              </div>
            </div>
            <div className="button-wrapper">
              <a href="/support" className="try-for-free_btn--b w-inline-block">
                <div className="button-border is-small-17">
                  <div className="button-inner-2">
                    <div className="text-button text-color">Support</div>
                    <div className="button-icon-wrap is-small-83">
                      <div className="button-icon is-small-203 w-embed">
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <g clipPath="url(#clip0_2013_416_ch)">
                            <path
