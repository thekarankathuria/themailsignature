/**
 * The first `.section_hero` from support.html — ported 1:1 from the Webflow original.
 *
 * The support address in the paragraph was served through Cloudflare's email-obfuscation
 * shim (`<a class="__cf_email__" data-cfemail="…">[email protected]</a>`, decoded at runtime
 * by a Cloudflare script that does not ship here). The address it decodes to is written
 * out plainly instead, rebranded to the project's domain.
 *
 * Theme: the chip SVG gradient stops are flattened to the flat accent (#EA4335), and the
 * `app.customesignature.com` signup link is rebranded. `.background-image` is kept in the
 * DOM because `app/ces-extra.css` already hides the decorative hero wash by selector.
 */
export function CesSupportHero() {
  return (
                ...
                <div className="section-sub-tag-title different-7">
                  <div className="bullet-list-icon different-8">
                    <div className="html-code different-9 w-embed">
                      ...
                      >
                        <g clipPath="url(#clip0_2003_12337_sh)">
                          <path
                            ...
                            fill="url(#paint0_linear_2003_12337_sh)"
                          ></path>
                        </g>
                        <defs>
                          <linearGradient
                            id="paint0_linear_2003_12337_sh"
                            x1="2.5"
                            y1="7.99843"
                            x2="13.4987"
                            y2="7.99843"
                          ...
                          <clipPath id="clip0_2003_12337_sh">
            ...
            <div className="hero_content">
              <div>
                <div className="heading_block">
                  <h2 className="heading-style-h1">Need Help?</h2>
                  <img
                ...
                <h1 className="heading-style-h1 home-hero">
                  <span className="highlight_text">Support Is Here</span>
                </h1>
              </div>
              <div className="paragraph_wrapper">
                <p className="text-size-medium">
                  If you have any support questions or need to cancel, please email{" "}
                  <strong className="highlight_text text-weight-bold">
              ...
              <a href="/contact-us" className="try-for-free_btn--b w-inline-block">
                <div className="button-border is-small-17">
                  <div className="button-inner-2">
                    <div className="text-button text-color">Contact Support</div>
